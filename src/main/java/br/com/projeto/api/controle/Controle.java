...
public class Controle {
    ...
    @GetMapping("/api/ordenaNomeIdade")
    public List<Pessoa> ordenarNomeIdade(){
        return acao.findByNomeOrderByIdade("Ana");
    }
    ...
    public String boasVindas(){
        return "Seja bem vindoa(a)!!!";
    }

    @GetMapping("/boasVindas/{nome}")
    public String boasVindas(@PathVariable String nome){
        return "Seja bem vindoa(a)!!! " + nome;
    }
